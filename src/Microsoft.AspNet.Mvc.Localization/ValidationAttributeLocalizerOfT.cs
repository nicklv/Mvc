...
{
    public class ValidationAttributeLocalizer<TAttribute, TResourceSource> :
        IValidationAttributeLocalizer<TAttribute, TResourceSource> where TAttribute : ValidationAttribute
    {
        private readonly IStringLocalizer _localizer;
        private readonly IValidationLocalizer<TAttribute> _attributeLocalizer;

        public ValidationAttributeLocalizer(
            IStringLocalizer<TResourceSource> localizer,
            IValidationLocalizer<TAttribute> attributeLocalizer)
        {
    ...
    {
        public override LocalizedString FormatMessage(
            ValidationAttributeLocalizationContext<FileExtensionsAttribute> context)
        {
    ...
    {
        public override LocalizedString FormatMessage(
            ValidationAttributeLocalizationContext<StringLengthAttribute> context)
        {
            return context.Localizer.GetString(
                context.Attribute.ErrorMessage,
                context.ValidationContext.MemberName,
    ...
    {
        public override LocalizedString FormatMessage(
            ValidationAttributeLocalizationContext<RangeAttribute> context)
        {
            return context.Localizer.GetString(
                context.Attribute.ErrorMessage,
                context.ValidationContext.MemberName,
    ...
    {
        public override LocalizedString FormatMessage(
            ValidationAttributeLocalizationContext<MaxLengthAttribute> context)
        {
            return context.Localizer.GetString(
                context.Attribute.ErrorMessage,
                context.ValidationContext.MemberName,
    ...
    {
        public override LocalizedString FormatMessage(
            ValidationAttributeLocalizationContext<RegularExpressionAttribute> context)
        {
            return context.Localizer.GetString(
                context.Attribute.ErrorMessage,
                context.ValidationContext.MemberName,
